...
#solar
src_oel = Source('src oel')
snk_oel = Sink('snk oel')
cmp_eco_solar1 = HeatExchanger('solareco1')
cmp_eco_solar2 = HeatExchanger('solareco2')
cmp_eco_solar3 = HeatExchanger('solareco3')
...
D12 = Connection(cmp_pmp1, 'out1', cmp_eco_solar1, 'in2', label='D12')
D13 = Connection(cmp_eco_solar1, 'out2', cmp_eco1, 'in2', label='D13')
...
D22 = Connection(cmp_pmp2, 'out1', cmp_eco_solar2, 'in2', label='D22')
D23 = Connection(cmp_eco_solar2, 'out2', cmp_eco2, 'in2', label='D23')
...
D32 = Connection(cmp_pmp3, 'out1', cmp_eco_solar3, 'in2', label='D32')
D33 = Connection(cmp_eco_solar3, 'out2', cmp_eco3, 'in2', label='D33')
...
#connection Solar
I1 = Connection(src_oel, 'out1', cmp_eco_solar1, 'in1', label='I1')
I2 = Connection(cmp_eco_solar1, 'out1', cmp_eco_solar2, 'in1', label='I2')
I3 = Connection(cmp_eco_solar2, 'out1', cmp_eco_solar3, 'in1', label='I3')
I4 = Connection(cmp_eco_solar3, 'out1', snk_oel, 'in1', label='I4')

steamgenerator.add_conns(I1, I2, I3, I4)
...
cmp_eco_solar1.set_attr(pr1=1, pr2=1)
...
cmp_eco_solar2.set_attr(pr1=1, pr2=1)
...
cmp_eco_solar3.set_attr(pr1=1, pr2=1)
...
#Data Solar Connections
I1.set_attr(m=138.9, T=300, p=10, fluid=oel)
