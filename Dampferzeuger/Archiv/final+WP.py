...
#Wärmepumpe
cmp_hitze = HeatExchanger('WP Verdampfer')
cmp_komp = Compressor('WP Kompressor')
cmp_wp_eco1 = HeatExchanger('vorwärmer1')
cmp_wp_eco2 = HeatExchanger('vorwärmer2')
cmp_wp_eco3 = HeatExchanger('vorwärmer3')
cmp_valve = Valve('WP Drossel')
...
c11 = Connection(cmp_eco3, 'out1', cmp_hitze, 'in1', label='11')
c12 = Connection(cmp_hitze, 'out1', snk_fg, 'in1', label='12')
...
D102 = Connection(cmp_pmp1, 'out1', cmp_wp_eco1, 'in2', label='D102')
D103 = Connection(cmp_wp_eco1, 'out2', cmp_eco1, 'in2', label='D103')
...
D202 = Connection(cmp_pmp2, 'out1', cmp_wp_eco2, 'in2', label='D202')
D203 = Connection(cmp_wp_eco2, 'out2', cmp_eco2, 'in2', label='D203')
...
D302 = Connection(cmp_pmp3, 'out1', cmp_wp_eco3, 'in2', label='D302')
D303 = Connection(cmp_wp_eco3, 'out2', cmp_eco3, 'in2', label='D303')
...
#Solar Cycle
wp1 = Connection(cyclecloser2, 'out1', cmp_hitze, 'in2', label='WP1')
wp2 = Connection(cmp_hitze, 'out2', cmp_komp,'in1', label='WP2')
wp3 = Connection(cmp_komp, 'out1', cmp_wp_eco1, 'in1', label='WP3')
wp4 = Connection(cmp_wp_eco1, 'out1', cmp_wp_eco2, 'in1', label='WP4')
wp5 = Connection(cmp_wp_eco2, 'out1', cmp_wp_eco3, 'in1', label='WP5')
wp6 = Connection(cmp_wp_eco3, 'out1', cmp_valve, 'in1', label='WP6')
wp7 = Connection(cmp_valve, 'out1', cyclecloser2, 'in1', label='WP7')

steamgenerator.add_conns(wp1, wp2, wp3, wp4, wp5, wp6, wp7)
...
cmp_wp_eco1.set_attr(pr1=1, pr2=1)
...
cmp_wp_eco2.set_attr(pr1=1, pr2=1)
...
cmp_wp_eco3.set_attr(pr1=1, pr2=1)
...
#
#Wärmepumpedata
cmp_hitze.set_attr(pr1=1, pr2=1)

#Wärmepumpe data connection
wp2.set_attr(p=5)
wp3.set_attr(T=120, p=10, m=2, fluid=Helium)
wp6.set_attr(T=100)
...
heatProducer.add_comps(
    ...
    {'comp': cmp_wp_eco1,'base': 'bus'},
    {'comp': cmp_wp_eco2,'base': 'bus'},
    {'comp': cmp_wp_eco3,'base': 'bus'}
)
